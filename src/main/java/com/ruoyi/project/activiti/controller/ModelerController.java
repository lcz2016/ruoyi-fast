...
public class ModelerController{
     ...
     * @return
     */
    @GetMapping("/activiti/editor")
    public String editor(){
        return "/activiti/freemarker/modeler.html";
    }
     ...
     */
    @ResponseBody
    @RequestMapping("/activiti/publish")
     ...
     */
    @ResponseBody
    @RequestMapping("/activiti/revokePublish")
     ...
     */
    @ResponseBody
    @RequestMapping("/activiti/delete")
	 ...
	 * 启动流程
	 */
	@RequestMapping("/activiti/start/{id}")
